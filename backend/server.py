...
async def seed_cms_data(current_user: User = Depends(require_role("admin"))):
    ...
    if not ai_team_section:
        ...
        ai_characters = [
            ...
            {"title": "Hugo", "description": "Self-help & wellness", "image_url": "https://static.prod-images.emergentagent.com/jobs/56155002-fa62-4b53-8fda-4baf701ab83f/images/6be1ae886e76d7b380a66ef3eb98c183e26882fe8e9897aab7e8a8ad4320acb9.png", "route": "/hugo-chat"},
